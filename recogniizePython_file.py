...
print(type(fruit))  # - log statement | - type check | - Data Types - Composite - Tuples - access value
print(pizza_toppings[1])  # - log statement | - Data Types - Composite - List - access value
pizza_toppings.append('Mushrooms') # - Data Types - Composite - List - change value - add value
print(person['name'])  # - log statement | - Data Types - Composite - Dictionary - access value
person['name'] = 'George' # - Data Types - Composite - Dictionary - access value - change value
person['eye_color'] = 'blue' # - Data Types - Composite - Dictionary - access value - add value
...
pizza_toppings.pop(1) # - Data Types - Composite - List - change value - delete value

print(person)  # - log statement
person.pop('eye_color') # - Data Types - Composite - Dictionary - access value - delete value
print(person)  # - log statement
